...
char *operadores[NOP] = {"(",")","[","]",".",",","->","++","--","~","!","*","&","+","-","<<",">>","<",">","<=",">=","/","/*","*/","%","==","!=","^","|","||","&&","?","=","*=","/=","%=","+=","-=",">>=", "<<=", "&=", "^=", "!="};
char *declaracoes[NDEC] = {"char","const","double","float","int","long","signed","unsigned","void", "short"};
char *lacos[NLOOP] = {"while","for"};
char *flux[NFLUX] = {"if","else","switch","case"};
char *reservadas[NRER] = {"auto","break","continue","default","do","enum","extern","goto","register","return","sizeof","static","struct","typedef","union","volatile"};
